...
export const DataProvider = ({ children }) => {
  ...
  return (
    <DataContext.Provider value={{ userComplaints, assigned, complaints, users, profile, loading, error, fetchComplaints, fetchUsers, fetchProfile, fetchAssigned, fetchUserComplaints }}>
      {children}
