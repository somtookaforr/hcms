                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    {users.map((x, key) => (
                      <div className="shadow-lg p-5 rounded" key={key}>
                        ...
                        <p>
                          <span className="text-red-600">Phone no: </span>
                          {x.phone_number}
                        </p>
                        ...
                        <div className="grid grid-cols-2 gap-x-4">
                          <button
                            type="submit"
                            className="w-full bg-green-600 h-12 rounded text-white mt-8"
                            onClick={activate}
                          >
                            Activate
                          </button>
                          <button
                            type="submit"
                            className="w-full bg-red-600 h-12 rounded text-white mt-8"
                            onClick={deactivate}
                          >
                            Deactivate
                          </button>
                    ...
                    <div className="shadow-sm clear-both p-4">
                      ...
                      >
                        <div className="">
                          ...
                          <input
                            type="text"
                            className="rounded h-11 w-full mt-1 p-1 border border-blue-400"
