    ...
    <div className='grid bg-blue-950'>
        ...
        <form onSubmit={handleSubmit} className='w-11/12 lg:w-1/3 grid gap-y-4 p-10 rounded border border-blue-400 justify-self-center my-20'>
            <div className="">
                ...
                <input type="text" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='first_name' onChange={handleChange} required />
            </div>
            
            <div className="name">
                <label htmlFor="" className='text-white'>Last Name</label> <br/>
                <input type="text" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='last_name' onChange={handleChange} required />
            </div>
            
            <div className="email">
                <label htmlFor="" className='text-white'>Email</label> <br/>
                <input type="email" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='email' onChange={handleChange} required />
            </div>
            
            <div className="name">
                <label htmlFor="" className='text-white'>User Name</label> <br/>
                <input type="text" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='username' onChange={handleChange} required /> 
            </div>

            <div className="number">
                <label htmlFor="" className='text-white'>Phone Number</label> <br/>
                <input type="text" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='phone_number' onChange={handleChange} required />
            </div>
            
            <div className="user">
                <label htmlFor="" className='text-white'>User Type</label> <br/>
                <select name="user_type" id="" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' onChange={handleChange} required>
                    <option value="">-Select-</option>
                    <option value={1}>Admin</option>
                    <option value={2}>Staff</option>
                    <option value={3}>Student</option>
                </select>
                {/* <input type="text" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='user_type' value={formData.user_type} onChange={handleChange} required />     */}
            </div>
            ...
            {formData.user_type == '2' ?
                <> 
                    <div className="number">
                        ...
                        <input type="text" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='role' onChange={handleChange} required />
                    </div>
                </>
                ...
                <>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='matric_no' onChange={handleChange} required />
                        </div>

                        <div>
                            <label htmlFor="" className='text-white'>Department</label> <br/>
                            <select name="department" id="" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' onChange={handleChange} required >
                                <option value="">-Select-</option>
                        ...
                        <div>
                            ...
                            <input type="text" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='room_number' onChange={handleChange} required />
                        </div>
                    </div>   
                </>
                : ''
            ...
            <div className="password">
                ...
                <input minLength={8} type="password" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='password' onChange={handleChange} required />
            </div>
            
            <div className="password">
                <label htmlFor="password" className='text-white'>Confirm Password</label> <br/>
                <input minLength={8} type="password" className='rounded h-11 w-full mt-1 p-2 border border-blue-400' name='password2' onChange={handleChange} required />
            </div>
